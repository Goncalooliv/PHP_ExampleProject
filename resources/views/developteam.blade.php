...
<section id="team" class="pb-5">
    <div class="container">
        <h3 class="text-center"><strong>Development Team</strong></h3>
        <div class="row">
            <div class = "col">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <a class="btn btn-dark" href="https://www.instagram.com/goncaloo_olv/" >Instagram
                            ...
                            <li class="list-group-item">
                                <a class="btn btn-dark" href="https://github.com/Goncalooliv"> GitHub 
                            ...
                            <li class="list-group-item">
                                <a class="btn btn-dark" href="https://www.facebook.com/GoncaloOliv28" >Facebook
